...
ProjectDir="C:\Working\Business\FT\FTTAG\Fw\V2\APP.X"
ProjectName=APP
ConfName=default
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/APP.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
...
${DISTDIR}/APP.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	@"C:/Program Files/Microchip/MPLABX/v6.05/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v6.05/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" ${DISTDIR}/APP.X.${IMAGE_TYPE}.hex -o${DISTDIR}/APP.X.${IMAGE_TYPE}.hex
