...
#define CELL_ONOFF_TRIG_SetHigh()           Indicator_SetState(4, 1, 0, IND_LOOP_FOREVER)
#define CELL_ONOFF_TRIG_SetLow()            Indicator_SetState(4, 0, 1, IND_LOOP_FOREVER)
#define CELL_ONOFF_TRIG_OneShot(Ton)        Indicator_SetState(4, Ton, 1, 1)
#define CELL_ONOFF_TRIG_Toggle(Ton, Toff)   Indicator_SetState(4, Ton, Toff, IND_LOOP_FOREVER)
