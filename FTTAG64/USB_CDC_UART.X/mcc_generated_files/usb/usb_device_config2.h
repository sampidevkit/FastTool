...
/** DEFINITIONS ****************************************************/
#define NUM_OF_USB_CDC	2

extern void *CDCDataOutHandle;
extern void *CDCDataInHandle;
extern volatile unsigned char cdc_data_tx[NUM_OF_USB_CDC][CDC_DATA_IN_EP_SIZE];
extern volatile unsigned char cdc_data_rx[NUM_OF_USB_CDC][CDC_DATA_OUT_EP_SIZE];
